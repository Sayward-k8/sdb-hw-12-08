...
# Решение 1
  ...
  Для решения данной задачи необходим полный + инкрементный бэкап. Для восстановление за час нужно использовать технологию восстановления на момент времени (PITR). Получается, что мы сначала также разворачиваем последний полный бэкап, а затем последовательно накатываем все инкрементные изменения
